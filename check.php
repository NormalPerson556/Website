...
<body>
    ...
    <div class="container-fluid page-header mb-5 py-5">
        <div class="container">
            <h1 class="display-3 text-white mb-3 animated slideInDown">My Trip</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Pages</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">My Trip</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <h1 class="mb-4">Check Your Ticket or Reschedule</h1>
    <form action="check_ticket.php" method="POST">
        <div style="margin-bottom: 1em;">
            <label for="ticket_number" style="font-size: 1.2em; display: block;">Enter Ticket Number:</label>
            <input 
                type="text" 
                name="ticket_number" 
                id="ticket_number" 
                ...
                style="padding: 0.5em; font-size: 1em; width: 50%; max-width: 300px; margin: 0 auto;"
            >
        </div>
        <button 
            type="submit" 
            name="check_ticket" 
            style="padding: 0.7em 2em; font-size: 1em; background-color: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer;"
        >
            Check Ticket
        </button>
    </form>
